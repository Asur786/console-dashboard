...
behavior-changing work by constitution; they may be skipped only for
documentation-only or non-behavioral changes when explicitly justified.
...
- [ ] T010 Define observability/performance acceptance checks for impacted flows
